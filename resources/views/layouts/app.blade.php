...
<body>
    ...
    @if ($errors->any())
        <div class="alert alert-danger m-auto w-1/2">
            @foreach ($errors->all() as $error)
                <ul class="bg-red-600 text-white m-1 p-2 rounded-xl ">
                    <li>{{ $error }}</li>
                </ul>
            @endforeach
        </div>
    ...
    <footer>
        <div class="mt-20 mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <ul class="text-black  font-medium">
                            <li class="mb-4">
                                <a href="https://youtube.com/watch?v=dQw4w9WgXcQ"
                                    class="hover:underline">Ügyfélszolgálat</a>
                            </li>
                            <li>
                    ...
                    <div>
                        <ul class="text-black  font-medium">
                            ...
                            <li>
                                <a href="https://youtube.com/watch?v=dQw4w9WgXcQ" class="hover:underline">Adatkezelési
                                    tájékoztató</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        <ul class="text-black-600  font-medium">
                            <li class="mb-4">
                                <a href="https://youtube.com/watch?v=dQw4w9WgXcQ" class="hover:underline">Weboldal
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-[#9128ed] sm:text-center">© 2023 <a href="#"
                        class="hover:underline">Foodpanda Kópia™</a>. Jog nincs fenntartva.
                </span>
                <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://www.youtube.com/" class="text-[#9128ed] hover:text-black ">
                        <svg class="w-7 h-7" fill="currentColor" viewBox="0 -1 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
